...
object CultivationSetting {
    ...
    val SpecPersonFirstName3:MutableList<PresetInfo> = mutableListOf(
            ...
            PresetInfo(13010031, Pair("\u82cf","\u6a31")), PresetInfo(13010041, Pair("\u674e","\u7ea2\u8896")),
            PresetInfo(13010050, Pair("\u695a","\u7559\u9999")),PresetInfo(13010061, Pair("\u98ce","\u56db\u5a18")),
