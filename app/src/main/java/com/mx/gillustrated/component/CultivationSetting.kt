...
object CultivationSetting {
    ...
    val CommonColors = arrayOf("#EAEFE8", "#417B29", "#367CC4", "#7435C1", "#D22E59", "#FB23B7", "#CDA812", "#F2E40A", "#04B4BA", "#C18135", "#A5529E", "#EEF192")
    ...
    val SpecPersonFirstName2:MutableList<PresetInfo> = mutableListOf(
            ...
            PresetInfo(12000221, Pair("\u8d75","\u7075\u513f"),12000200, 500, 1000),
            PresetInfo(12000231, Pair("\u6797","\u6708\u5982"),12000200, 200, 600)
     )
